     ...
     <div className="hero-section">
      ...
      <div className="hero-section">
        <div className="hero-left">
          ...
          <div className="hero-description">
          Hi there! I’m Shray Rathore, the Co-Founders of Pseudo owner. I'm thrilled to welcome you to our corner of the digital world.
      ...
      <div className="hero-section">
        <div className="hero-left">
          ...
          <div className="hero-description">
          Hi there! I’m Srishti Ajmera, the Co-Founders of Pseudo owner. I'm thrilled to welcome you to our corner of the digital world.
      ...
      <div className="hero-section">
        <div className="hero-left">
          ...
          <div className="hero-description">
          Hi there! I’m Vivek Kumar, the Co-Founders of Pseudo owner. I'm thrilled to welcome you to our corner of the digital world.
          </div>
        </div>
        <div className="hero-right">
